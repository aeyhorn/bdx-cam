...
## 2. Neuen Fall erfassen (wichtigster Ablauf)
...
## 3. Eigene Faelle nachverfolgen

1. Im Menue `Meine Faelle` oeffnen.
2. Fall in der Liste suchen.
...
## 4. Dateien am Fall nutzen

In der Falldetailansicht koennen je nach Berechtigung Anhaenge genutzt werden:
...
- **Speichern nicht sichtbar** -> Fall erneut oeffnen und Status/Kommentar pruefen.
